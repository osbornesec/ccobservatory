              ...
              <div class="card-body">
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <p class="text-3xl font-bold text-info">{Math.round(analytics.avg_conversation_length)}</p>
                  </div>
                  <div class="text-info">
                    <Clock class="w-8 h-8" />
                  </div>
            ...
            <div class="card bg-base-100 shadow-lg border border-base-300">
              <div class="card-body">
                ...
                <div class="space-y-3">
                  ...
                  <div class="flex items-center justify-between">
                    <span>WebSocket</span>
                    <div class="badge {$connectionStatus === 'connected' ? 'badge-success' : 'badge-warning'}">
